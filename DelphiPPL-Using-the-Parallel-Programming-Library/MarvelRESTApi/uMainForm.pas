...
const
  PUBLIC_KEY: string = 'obtenha sua key em https://developer.marvel.com/documentation/generalinfo';
  PRIVATE_KEY: string = 'obtenha sua key em https://developer.marvel.com/documentation/generalinfo';
